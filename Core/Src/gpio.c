...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, MULTI7_E_Pin|MULTI7_S1_Pin|MULTI7_S2_Pin|MULTI8_S2_Pin
  ...
  HAL_GPIO_WritePin(GPIOB, MULTI1_E_Pin|MULTI1_S1_Pin|MULTI1_S2_Pin|MULTI1_S3_Pin
                          ...
                          |MULTI6_E_Pin|MULTI6_S1_Pin|MULTI6_S2_Pin|MULTI6_S3_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = MULTI7_E_Pin|MULTI7_S1_Pin|MULTI7_S2_Pin|MULTI8_S2_Pin
                          |MULTI8_S3_Pin|MULTI2_S1_Pin|MULTI2_S2_Pin|MULTI2_S3_Pin
                          |MULTI3_E_Pin|MULTI4_S1_Pin|MULTI4_S2_Pin|MULTI4_S3_Pin;
  ...
  GPIO_InitStruct.Pin = MULTI1_E_Pin|MULTI1_S1_Pin|MULTI1_S2_Pin|MULTI1_S3_Pin
                          |MULTI2_E_Pin|MULTI5_S1_Pin|MULTI5_S2_Pin|MULTI5_S3_Pin
                          |MULTI6_E_Pin|MULTI6_S1_Pin|MULTI6_S2_Pin|MULTI6_S3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
